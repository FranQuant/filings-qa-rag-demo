...
def build_parser() -> argparse.ArgumentParser:
    ...
    fetch_parser.add_argument("--period", required=True, help="Period label (e.g., Q2).")
    ...
    parse_parser.add_argument("--period", required=True, help="Period label (e.g., Q2).")
    ...
    index_parser.add_argument("--period", required=True, help="Period label (e.g., Q2).")
    ...
    embed_parser.add_argument("--period", required=True, help="Period label (e.g., Q2).")
    ...
    retrieve_parser.add_argument("--period", required=True, help="Period label (e.g., Q2).")
    ...
    answer_parser.add_argument("--period", required=True, help="Period label (e.g., Q2).")
